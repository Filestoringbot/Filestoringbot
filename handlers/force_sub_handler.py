    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="Sorry ,my friend, You are Banned to use me. Contact my [Support Group](https://t.me/+3zF9tC_HoQEyZGVl).",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ](https://t.me/+3zF9tC_HoQEyZGVl).",
            disable_web_page_preview=True
        )
        return 200
    return 200
